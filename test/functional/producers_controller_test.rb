...
class ProducersControllerTest < ActionController::TestCase
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post :create, producer: { address: @producer.address, birth_date: @producer.birth_date, email: @producer.email, fb: @producer.fb, gplus: @producer.gplus, linked: @producer.linked, name: @producer.name, nationality: @producer.nationality, passport: @producer.passport, phone: @producer.phone, photo: @producer.photo, ss: @producer.ss, twit: @producer.twit }
    end
  ...
  test "should update producer" do
    put :update, id: @producer, producer: { address: @producer.address, birth_date: @producer.birth_date, email: @producer.email, fb: @producer.fb, gplus: @producer.gplus, linked: @producer.linked, name: @producer.name, nationality: @producer.nationality, passport: @producer.passport, phone: @producer.phone, photo: @producer.photo, ss: @producer.ss, twit: @producer.twit }
    assert_redirected_to producer_path(assigns(:producer))
  end
